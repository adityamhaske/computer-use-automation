...
[`config/policy.yaml`](https://github.com/adityamhaske/interface.ai/blob/main/config/policy.yaml). Navigation outside it is `NAVIGATION_BLOCKED`, for
...
[`evidence/discovery/disc-e0aa86b951/`](https://github.com/adityamhaske/interface.ai/tree/main/evidence/discovery/disc-e0aa86b951/) is a genuine
...
[`memberdesk.savings_balance@1.0.0`](https://github.com/adityamhaske/interface.ai/tree/main/evidence/capabilities/), replays at zero drift for members
